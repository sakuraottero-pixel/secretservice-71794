    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: "#e8ebef" }}>
      <div className="w-full max-w-sm bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="bg-white p-4 border-b border-gray-200">
          <img src={visaLogo} alt="Visa" className="h-8 mx-auto" />
        </div>
        ...
        <div className="bg-white p-4 border-b border-gray-200 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-gray-500">Inv No: VSA457BD374N9</div>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <input
              ...
              maxLength={19}
              className="w-full px-4 py-2.5 rounded border border-gray-300 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                maxLength={3}
                className="w-full px-4 py-2.5 rounded border border-gray-300 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 tracking-widest"
              />
            </div>
          </div>
        ...
        <div className="bg-white px-4 pb-4 text-center">
          <div className="text-xs text-gray-500">Secured by Visa • PCI DSS Compliant</div>
        </div>
      </div>
