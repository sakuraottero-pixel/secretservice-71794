    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: "#e8ebef" }}>
      <div className="w-full max-w-sm bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="bg-white p-4 border-b border-gray-200">
          <img src={bkashLogo} alt="bKash" className="h-8 mx-auto" />
        </div>
        ...
        <div className="bg-white p-4 border-b border-gray-200 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-gray-500">Inv No: BGT457BD374N9</div>
            </div>
          </div>
        ...
        {/* Pink Section */}
        <div className="p-6" style={{ backgroundColor: "#e2136e" }}>
          ...
          <div className="text-center text-white text-xs">
            Confirm and proceed.{" "}
            <a href="https://www.bkash.com/terms-and-conditions" target="_blank" rel="noopener noreferrer" className="underline">
              terms & conditions
            </a>
          </div>
        </div>
          ...
          <button
            ...
            style={
              accountNumber.length === 11 && !loading
                ? { backgroundColor: "#e2136e", color: "white", borderColor: "#e2136e", cursor: "pointer" }
                : {}
            }
          >
        ...
        <div className="bg-white px-4 pb-4 text-center">
          <div className="flex items-center justify-center gap-1 text-xs text-gray-600 mb-2">
            ...
            <a href="tel:16247" className="font-semibold text-pink-600 hover:underline">16247</a>
          </div>
          <div className="text-xs text-gray-500">© 2023 bKash, All Rights Reserved</div>
        </div>
      </div>
